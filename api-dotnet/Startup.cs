    ...
    public class Startup
    {
    ...
    }   private void SeedDatabase(DataContext context)
        {
            ...
            context.Orders.AddRange(new []{
                new Order{ OrderDate = new DateTime(2021,8,1), Staus = OrderStatus.Fulfilled },
                new Order{ OrderDate = new DateTime(2021,8,1), Staus = OrderStatus.Accepted },
                new Order{ OrderDate = new DateTime(2021,8,2), Staus = OrderStatus.Fulfilled },
                new Order{ OrderDate = new DateTime(2021,8,3), Staus = OrderStatus.Accepted },
                new Order{ OrderDate = new DateTime(2021,8,3), Staus = OrderStatus.Draft },
            });
            context.SaveChanges();
